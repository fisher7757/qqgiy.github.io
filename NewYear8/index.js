...
window.onload=function () {
    ...
    function imgLoaded(){
        ...
        $('.f21 img').attr('src','images/22.png')
        $('.a3 img').attr('src','images/31.png')
        $('.f31 img').attr('src','images/32.png')
        $('.a4 img').attr('src','images/41.png')
        $('.f41 img').attr('src','images/42.png')
        $('.a5 img').attr('src','images/51.png')
        $('.f51 img').attr('src','images/52.png')
        $('.a6 img').attr('src','images/61.png')
        $('.f61 img').attr('src','images/62.png')
        $('.a7 img').attr('src','images/71.png')
        $('.f71 img').attr('src','images/72.png')
        $('.a8 img').attr('src','images/81.png')
        $('.f81 img').attr('src','images/82.png')
        $('.a9 img').attr('src','images/91.png')
        $('.f91 img').attr('src','images/92.png')
